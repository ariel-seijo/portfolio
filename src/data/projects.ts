...
export const PROJECTS: Project[] = [
  {
    ...
    images: [
      { src: "/ecommerce-1.webp", alt: "Página principal de Electroshop" },
      { src: "/ecommerce-2.webp", alt: "Página de producto" },
      { src: "/ecommerce-3.webp", alt: "Página de productos y carrito de compras" },
      { src: "/ecommerce-4.webp", alt: "Proceso de compra en computadora y celular" },
      { src: "/ecommerce-5.webp", alt: "Dashboard de administrador con métricas" },
      { src: "/ecommerce-6.webp", alt: "Página de gestión de inventario" },
      { src: "/ecommerce-7.webp", alt: "Página de edición de producto" },
  ...
  },
  {
    ...
    images: [
      { src: "/oid-1.webp", alt: "Página principal de Oid Mortales" },
      { src: "/oid-2.webp", alt: "Ejemplo 1 de ejercicio del test"},
      { src: "/oid-3.webp", alt: "Ejemplo 2 de ejercicio del test" },
      { src: "/oid-4.webp", alt: "Ejemplo 3 de ejercicio del test" },
      { src: "/oid-5.webp", alt: "Ejemplo 4 de ejercicio del test" },
      { src: "/oid-6.webp", alt: "Pagina de resultados del test de Oid Mortales" },
    ],
